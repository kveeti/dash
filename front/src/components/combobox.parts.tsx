...
function getInputClass(_size: ComboboxSize) {
	return "bg-gray-1 dark:bg-gray-3 w-full shrink-0 border-b border-gray-a3 outline-none max-sm:bg-white px-2.5 h-9 text-[13px]";
}

function getItemClass(_size: ComboboxSize) {
	return "data-[highlighted]:bg-gray-a3 hover:bg-gray-a3 flex cursor-default items-center outline-none select-none rounded-sm min-h-8 px-2 py-1 text-[13px] mx-1";
}
