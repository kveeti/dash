	...
	return (
		<_Dialog.Portal>
			{props.overlay !== false && (
				<_Dialog.Overlay
					className={
						"fixed inset-0 bg-gray-a4 dark:bg-black-a5 backdrop-blur-[2px]" +
			...
			<_Dialog.Content
				{...props}
				className={
					"bg-gray-1 border-gray-a4 fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[26rem] transform-[translate(-50%,_-50%)] border rounded-lg p-5 outline-none shadow-[0_24px_64px_-12px_rgba(0,0,0,0.18),0_2px_8px_-2px_rgba(0,0,0,0.08)] dark:shadow-[0_24px_64px_-12px_rgba(0,0,0,0.7),0_2px_8px_-2px_rgba(0,0,0,0.4)]" +
