...
export async function getYearStats(input: {
	db: DbHandle;
	from: string;
	to: string;
	sourceCurrency?: string;
...
export async function getMonthStats(input: {
	db: DbHandle;
	from: string;
	to: string;
	sourceCurrency?: string;
...
export async function getConvertedStatsSummary(input: {
	db: DbHandle;
	from: string;
	to: string;
	sourceCurrency?: string;
...
export async function getConvertedStatTransactions(input: {
	db: DbHandle;
	from: string;
	to: string;
	sourceCurrency?: string;
...
export async function getTransactionYears(db: DbHandle): Promise<TransactionYearRow[]> {
